...
from .views import StoreInventoryListView, WarehouseInventoryListView, StoreInventoryUpdateView, StoreMonthEndInventoryUpdateView, StoreMonthEndInventoryListView, WarehouseInventoryUpdateView
urlpatterns = [
    ...
    path('warehouse_inventory_update/', WarehouseInventoryUpdateView.as_view(), name='warehouse-inventory-update'),
]