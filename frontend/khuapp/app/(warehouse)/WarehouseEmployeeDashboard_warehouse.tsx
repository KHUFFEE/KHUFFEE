...
const WarehouseEmployeeDashboard_warehouse: React.FC<
  WarehouseEmployeeDashboardProps
> = ({ storeName, activeView, setActiveView }) => {
  ...
  return <View style={styles.dashboardContainer}>{renderView()}</View>;
};
