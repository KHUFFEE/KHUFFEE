...
export const warehouseIncomingDownloadExcel = ({
  ...
  // 공급업체가 바뀌는 지점에서는 굵은 하단 선(두꺼운 선)을 추가함
  ...
  // 데이터 영역 스타일 (데이터 행: row index 4 ~ totalsRowIndex-1)
